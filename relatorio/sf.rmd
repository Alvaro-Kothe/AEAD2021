...
Pela Figura \@ref(fig:resp-lag), nota-se que existe uma forte relação linear entre a resposta e a sua defasagem.
...
De acorto com o pacote `caret`, o principal hiper-parâmetro de floresta aleatória a ser otimizado é o número de variáveis amostradas em cada divisão da árvore (`mtry`). Para isso, foi escolhido aleatóriamente 10 valores para esse hiper-parâmetro, e foram comparados por validação cruzada fixando o número de árvores em 50. O parâmetro escolhido da amostra de 10 foi testado novamente, só que dessa vez comparado com 3 valores na frente e atrás, fixando o número de árvores em 100. O hiper-parâmetro `mtry` escolhido foi 54.
